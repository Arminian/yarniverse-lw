        ...
        <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl w-full">
                <div class="bg-white rounded-lg shadow-lg p-8 text-center">
                    ...
                    <div class="text-left mb-8">
                        ...
                        <div class="space-y-3">
                            ...
                            @if($order->items->count() > 3)
                                <p class="text-sm text-gray-600 text-center">+ {{ $order->items->count() - 3 }} more items
                                </p>
                            @endif
                        </div>
                    </div>
                    ...
                    <!-- Shipping Info -->
                    <div class="bg-orange-50 rounded-lg p-4 mb-8 text-left">
                        <h4 class="font-semibold text-gray-900 mb-2">📦 Shipping Address</h4>
                        <p class="text-gray-700">
                            {{ $order->shipping_full_name }}<br>
                            {{ $order->shipping_address_line_one }}<br>
                            @if($order->shipping_address_line_two)
                                {{ $order->shipping_address_line_two }}<br>
                            @endif
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="{{ route('customer.orders.show', $order->id) }}"
                            class="inline-flex items-center justify-center bg-orange-600 text-white px-8 py-3 rounded-lg hover:bg-orange-700 transition font-semibold">
                    ...
                    <div class="mt-8 pt-8 border-t">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                            <div class="flex items-start gap-3">
                                <div
                                    class="flex-shrink-0 w-8 h-8 bg-yellow-100 text-orange-600 rounded-full flex items-center justify-center font-bold">
                                    1</div>
                                <div class="text-left">
