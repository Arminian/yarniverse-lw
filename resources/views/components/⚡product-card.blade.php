    ...
    <div class="group relative bg-white rounded-lg shadow-sm hover:shadow-lg transition duration-300 overflow-hidden">
        <a href="{{ route('products.show', $product->slug) }}" class="block">
            ...
            <div class="p-4">
                ...
                <!-- Product Name -->
                <h3 class="font-semibold text-gray-900 mb-2 line-clamp-2 group-hover:text-orange-600 transition">
                    {{ $product->name }}
                </h3>
        ...
        @if($product->stock_status === 'in_stock')
            <div class="p-4 pt-0">
                <button wire:click="addToCart"
                    class="w-full cursor-pointer bg-orange-600 text-white py-2 px-4 rounded-lg hover:bg-red-700 transition font-medium">
                    Add to Cart
                </button>
            </div>
        @else
            <div class="p-4 pt-0">
                <button disabled
                    class="w-full bg-gray-200 text-gray-400 py-2 px-4 rounded-lg cursor-not-allowed font-medium">
                    Out of Stock
                </button>
            </div>
        @endif
