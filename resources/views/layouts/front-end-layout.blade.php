...
<head>
    ...
    <title>{{ $title ?? config('app.name', 'Yarniverse') }}</title>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between py-4">
                ...
                <div class="flex content-between items-center">
                    <div>
                        <x-phosphor-yarn class="h-10 w-10 font-bold text-orange-600" />
                    </div>
                    <div>
                        <a href="{{ route('home') }}" class="text-2xl font-bold text-orange-600">
                            {{ config('app.name', 'Yarniverse') }}
                        </a>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4">
                    @auth('customer')
                        <a href="{{ route('customer.dashboard') }}" class="text-gray-700 hover:text-orange-600">
            ...
            <nav class="border-t py-4">
                <ul class="flex items-center gap-8">
                    ...
                    <li>
                        <a href="{{ route('products.index') }}" class="text-gray-700 hover:text-orange-600 font-medium">
                            Shop
                        </a>
                    </li>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="text-gray-400">Your one-stop shop for quality products: knit all you like.</p>
                </div>
                <div>
