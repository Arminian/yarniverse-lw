...
new #[Layout('layouts::front-end-layout')] class extends Component {
    ...
    {
        return $this->view()->title('Shopping Cart');
    }
};
?>
                    ...
                    <div class="lg:col-span-2 space-y-4">
                            ...
                            <div class="bg-white rounded-lg shadow-sm p-6">
                                <div class="flex gap-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        @endif
                                        <p class="text-lg font-bold text-amber-600">${{ number_format($item['price'], 2) }}</p>
                                    </div>
                        ...
                        <div class="flex justify-between items-center pt-6">
                            <button wire:click="clearCart" wire:confirm="Are you sure you want to clear the cart?"
                                class="text-red-600 hover:text-black hover:scale-105 font-large rounded bg-red-100 px-2 py-1">
                                Clear Cart
                            </button>
                            <a href="{{ route('products.index') }}" class="text-blue-600 hover:text-indigo-700 font-large">
                                ← Continue Shopping
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="bg-white rounded-lg shadow-sm p-6 sticky top-24">
                            ...
                            @auth('customer')
                                <a href="{{ route('checkout') }}"
                                    class="block w-full bg-orange-600 text-white text-center py-3 px-6 rounded-lg hover:bg-orange-700 transition font-semibold">
                                    Proceed to Checkout
                                </a>
                            @else
                                <a href="{{ route('login') }}"
