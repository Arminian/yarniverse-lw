...
new #[Layout('layouts::front-end-layout')] class extends Component {
    ...
    {
        return $this->view()->title($this->order->order_number . ' - ' . config('app.name'));
    }
};
?>
                ...
                <nav class="text-sm mb-4">
                    <ol class="flex items-center gap-2">
                        ...
                        <li><a href="{{ route('customer.orders') }}"
                                class="text-gray-500 hover:text-orange-600">Orders</a></li>
                        <li class="text-gray-400">/</li>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-gray-900">{{ $order->created_at->format('M d, Y h:i A') }}
                                </p>
                            </div>
                            <div>
                                ...
                                @foreach($order->statusHistories as $history)
                                    <div class="flex gap-4">
                                        <div class="flex-shrink-0">
                                            <div
                                                class="w-10 h-10 rounded-full bg-yellow-100 text-orange-600 flex items-center justify-center">
