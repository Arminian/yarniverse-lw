...
<div>
    <div class="bg-gray-50 py-8">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            {{-- Header --}}
            <div class="mb-10 font-bold text-end">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <div class="flex items-center justify-between">
                        ...
                        <div
                            class="w-12 h-12 bg-red-100 text-orange-600 rounded-full flex items-center justify-center">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <div class="flex items-center justify-between">
                        ...
                        <div
                            class="w-12 h-12 bg-yellow-100 text-yellow-600 rounded-full flex items-center justify-center">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900">${{ number_format($stats['total_spent'], 2) }}
                            </p>
                        </div>
                        <div
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div class="space-y-3">
                            <a href="{{ route('customer.orders') }}"
                                ...
                                <div
                                    class="w-10 h-10 bg-yellow-100 text-orange-600 rounded-lg flex items-center justify-center group-hover:bg-orange-600 group-hover:text-white transition">
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                <a href="{{ route('products.index') }}"
                                    class="inline-block bg-orange-600 text-white px-6 py-2 rounded-lg hover:bg-red-600 transition">
                                    Start Shopping
                                </a>
                            </div>
                        @endif
