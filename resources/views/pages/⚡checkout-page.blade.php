...
new #[Layout('layouts::front-end-layout')] class extends Component {
    ...
    protected function validateAddress()
    {
        if ($this->useExistingAddress) {
            ...
            // Verify the selected address belongs to the customer
        ...
        try {
            ...
            if ($this->useExistingAddress && $this->selectedAddressId) {
                ...
                $shippingData = [
                    ...
                    'shipping_address_line_one' => $address->address_line_one,
                    'shipping_address_line_two' => $address->address_line_two,
                ...
                $shippingData = [
                    ...
                    'shipping_address_line_one' => $this->address_line_one,
                    'shipping_address_line_two' => $this->address_line_two,
                                ...
                                @if($useExistingAddress)
                                    <div class="grid gap-4 mb-6">
                                        @foreach($addresses as $address)
                                            <label class="relative cursor-pointer wire:key=" address-{{ $address->id }}">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" wire:model="postal_code"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
                                            @error('postal_code') <span class="text-red-600 text-sm">{{ $message }}</span>
                                            @enderror
                                        </div>
                        ...
                        <div class="bg-white rounded-lg shadow-sm p-6">
                            ...
                            <div class="space-y-4 mb-6">
                                <label class="relative cursor-pointer">
                                    <input type="radio" wire:model="paymentMethod" value="stripe" class="peer sr-only">
                                    <div
                                        class="border-2 rounded-lg p-4 peer-checked:border-blue-600 peer-checked:bg-indigo-50 hover:border-indigo-400 transition">
