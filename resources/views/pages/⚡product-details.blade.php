                            ...
                            <div class="grid grid-cols-4 gap-4">
                                @foreach($product->images as $image)
                                    <button wire:click="selectImage('{{ $image->image_path }}')"
                                        class="aspect-square rounded-lg overflow-hidden border-2 {{ $selectedImage === $image->image_path ? 'border-orange-600' : 'border-gray-200' }} hover:border-amber-400 transition">
                    ...
                    <div>
                        ...
                        @if($product->stock_status === 'in_stock')
                            <button wire:click="addToCart"
                                class="w-full bg-orange-600 text-white py-3 px-6 rounded-lg hover:bg-orange-700 transition font-semibold text-lg">
                                Add to Cart
                            </button>
                        @else
                            <button disabled
                ...
                <div class="border-b">
                    <nav class="flex">
                        <button @click="activeTab = 'description'"
                            :class="{ 'border-orange-600 text-orange-700': activeTab === 'description' }"
                            class="px-6 py-4 border-b-2 font-medium transition">
                            Description
                        </button>
                        <button @click="activeTab = 'reviews'"
                            :class="{ 'border-orange-600 text-orange-700': activeTab === 'reviews' }"
                            class="px-6 py-4 border-b-2 font-medium transition">
